...
export default function Products() {
  ...
  function putInWishlist(itemName, description, images, category, userName, email) {
    ...
    fetch(
      `/api/putInWishlist?itemName=${encodeURIComponent(itemName)}&description=${encodeURIComponent(
        description
      )} &images=${encodeURIComponent(images)}&category=${encodeURIComponent(
        category
      )}&userName=${encodeURIComponent(userName)}&userEmail=${encodeURIComponent(email)}`
    );
  ...
  function putInRequest(userName, email, itemName, itemId, swapItemId, swapItemName) {
    ...
    setShowModal(false);
    fetch(
      `/api/putInRequest?userName=${encodeURIComponent(userName)}&userEmail=${encodeURIComponent(
        email
      )}&itemName=${encodeURIComponent(itemName)}&ItemId=${encodeURIComponent(
        itemId
      )}&swapItemId=${encodeURIComponent(swapItemId)}&swapItemName=${encodeURIComponent(swapItemName)}`
    );
